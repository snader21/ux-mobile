...
function MemoryChallengeSetupScreen() {
  ...
  const categories = [
    { label: "Juegos de pares", key: "pares" },
    { label: "Secuencias de números", key: "secuencias" },
    { label: "Memorizar lista", key: "memorizar" },
  ];
...
export default MemoryChallengeSetupScreen;
